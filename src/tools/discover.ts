...
// ⚡ Bolt: avoid array slicing/mapping in RSI to reduce GC overhead
...
async function buildCandidate(ticker: string): Promise<Candidate> {
  ...
  // ⚡ Bolt: Use direct indexing instead of .map() and .slice()
  // to prevent N arrays of memory allocation in the discovery loop
