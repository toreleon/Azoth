...
// ⚡ Bolt: Compute RSI directly from bars array to avoid allocating a slice window
...
async function buildCandidate(ticker: string): Promise<Candidate> {
  ...
  // ⚡ Bolt: Compute metrics using indexed loops to avoid chained array map/slice/reduce allocations
