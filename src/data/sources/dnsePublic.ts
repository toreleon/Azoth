...
function clipBars(bars: Bar[]): Bar[] {
  ...
  // Performance: In tight backtest loops, filtering an O(N) array creates massive overhead.
  // We use binary search since bars are chronologically sorted to make lookups O(log N).
