...
/**
 * Efficient O(log n) binary search for the last bar at or before the given time.
 * @param bars Chronologically sorted array of bars
 * @param timeSec Target time in unix seconds
 * @returns Index of the last bar, or -1 if no such bar exists
 */
