...
/**
 * Binary search to find the index of the last bar with a time <= targetTime.
 * Returns -1 if no such bar exists.
 * Time-series market data arrays are chronologically sorted; prefer O(log n) lookups.
 */
