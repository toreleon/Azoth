...
## 2026-08-30 - Optimize array allocations in hot paths
**Learning:** Chaining array methods like .map(), .slice(), and object spreads in the ticker discovery tool creates unnecessary memory allocation and GC overhead.
**Action:** Use in-place indexed for loops to compute metrics directly from source arrays.
